...
local kitty_quick_access = "kitten quick-access-terminal -o edge=bottom -- '/etc/nixos/scripts/kitty-quick-access.sh'"
...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("sleep 5 && systemctl --user stop swaync.service")
    hl.exec_cmd("systemctl --user start vicinae")
    hl.exec_cmd("netscope-backend")
end)
...
hl.config({
    general = {
        ...
        col = {
            active_border = { colors = { "rgba(bfc3f0ff)", "rgba(9b97f6ff)" }, angle = 45 },
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("caelestia shell drawers toggle launcher"))
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("caelestia shell drawers toggle session"))

-- music
hl.bind(mainMod .. "+ M", hl.dsp.exec_cmd("/etc/nixos/scripts/g4music.sh"))

-- screen reader (ocr)
hl.bind(mainMod .. "+ SHIFT + T", hl.dsp.exec_cmd("bash -c /etc/nixos/scripts/ocr-select"))
...
hl.bind("XF86Launch2", hl.dsp.exec_cmd(kitty_quick_access))
